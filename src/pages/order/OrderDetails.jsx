      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sm={6} md={4}>
          <Item>
            ...
            <Typography variant="body1">{order.status === 1 ? 'Completed' : order.status === 0 ? 'Pending' : 'Cancelled'}</Typography>
          </Item>
        </Grid>
        <Grid item xs={12} sm={6} md={4}>
          <Item>
            ...
            <Typography variant="body1">
              <NumericFormat value={order.total} displayType="text" thousandSeparator prefix="$" />
            </Typography>
          </Item>
        </Grid>
      </Grid>
